...
{ 
    ...
    { 
        ...
        [HttpPost]
        [Route("/test5169/mytest/1.0.0/pet")]
        [ValidateModelState]
        ...
        [HttpDelete]
        [Route("/test5169/mytest/1.0.0/pet/{petId}")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/test5169/mytest/1.0.0/pet/findByStatus")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/test5169/mytest/1.0.0/pet/findByTags")]
        [ValidateModelState]
        ...
        /// <response code="200">successful operation</response>
        [HttpPost]
        [Route("/test5169/mytest/1.0.0/pet/{petId}/uploadImage")]
        [ValidateModelState]
